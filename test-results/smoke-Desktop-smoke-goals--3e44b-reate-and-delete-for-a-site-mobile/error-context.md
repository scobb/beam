...
- Name: smoke.spec.ts >> Desktop smoke >> goals page supports create and delete for a site
- Location: test/smoke/smoke.spec.ts:403:7

# Error details

```
Error: Signup API returned 500 for smoke-1775543353022-yod6u@example.com
```
