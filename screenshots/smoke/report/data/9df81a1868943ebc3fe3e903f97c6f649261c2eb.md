...
- Name: smoke.spec.ts >> Desktop smoke >> embed widget is accessible for a public site
- Location: test/smoke/smoke.spec.ts:527:7

# Error details

```
Error: Signup API returned 500 for smoke-1775543354378-52xq3@example.com
```
