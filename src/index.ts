...
app.get('/sitemap.xml', (c) => {
  ...
  const paths = [
    ...
    '/blog/gdpr-analytics-no-cookie-banner',
    '/blog/april-2026-updates',
    '/blog/senbeacon-cors-analytics-fix',
    '/blog/nuxt-privacy-analytics',
    '/blog/matomo-alternative',
    '/blog/gdpr-analytics-mistakes',
    '/blog/indie-hacker-analytics',
    '/changelog',
    '/demo',
    '/migrate',
  ...
  const meta: Record<string, { changefreq: string; priority: string }> = {
    ...
    '/vs/posthog': { changefreq: 'monthly', priority: '0.8' },
    '/vs/mixpanel': { changefreq: 'monthly', priority: '0.8' },
    ...
    '/blog/gdpr-analytics-no-cookie-banner': { changefreq: 'monthly', priority: '0.8' },
    '/blog/april-2026-updates': { changefreq: 'monthly', priority: '0.7' },
    '/blog/senbeacon-cors-analytics-fix': { changefreq: 'monthly', priority: '0.7' },
    '/blog/nuxt-privacy-analytics': { changefreq: 'monthly', priority: '0.7' },
    '/blog/matomo-alternative': { changefreq: 'monthly', priority: '0.8' },
    '/blog/gdpr-analytics-mistakes': { changefreq: 'monthly', priority: '0.8' },
    '/blog/indie-hacker-analytics': { changefreq: 'monthly', priority: '0.7' },
    ...
    '/migrate/umami': { changefreq: 'weekly', priority: '0.8' },
    ...
    '/for/react': { changefreq: 'monthly', priority: '0.8' },
    '/for/vue': { changefreq: 'monthly', priority: '0.8' },
    '/for/nuxt': { changefreq: 'monthly', priority: '0.8' },
    '/for/svelte': { changefreq: 'monthly', priority: '0.8' },
    '/for/sveltekit': { changefreq: 'monthly', priority: '0.8' },
    '/for/gatsby': { changefreq: 'monthly', priority: '0.8' },
