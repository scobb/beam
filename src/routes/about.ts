...
<main class="max-w-4xl mx-auto px-6 py-16">
  ...
  <section class="mb-14">
    ...
    <div class="text-gray-700 space-y-2">
      ...
      <p><strong>npm:</strong> <a href="https://www.npmjs.com/package/beam-analytics" class="text-indigo-600 hover:underline">beam-analytics</a> — also available on npm for build-tool workflows</p>
    </div>
  </section>
