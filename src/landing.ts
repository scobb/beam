    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div class="text-center">
          ...
          <p class="text-gray-400 text-xs mt-2">Browse all setup guides at <a href="/for" class="text-indigo-500 hover:underline">/for</a>, including <a href="/for/nextjs" class="text-indigo-500 hover:underline">Next.js</a>, <a href="/for/react" class="text-indigo-500 hover:underline">React</a>, <a href="/for/wordpress" class="text-indigo-500 hover:underline">WordPress</a>, <a href="/for/hugo" class="text-indigo-500 hover:underline">Hugo</a>, <a href="/for/astro" class="text-indigo-500 hover:underline">Astro</a>, <a href="/for/webflow" class="text-indigo-500 hover:underline">Webflow</a>, <a href="/for/shopify" class="text-indigo-500 hover:underline">Shopify</a>, <a href="/for/ghost" class="text-indigo-500 hover:underline">Ghost</a>, <a href="/for/framer" class="text-indigo-500 hover:underline">Framer</a>, and <a href="/for/carrd" class="text-indigo-500 hover:underline">Carrd</a>.</p>
        </div>
